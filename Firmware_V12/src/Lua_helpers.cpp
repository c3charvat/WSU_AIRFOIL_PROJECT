...
String LuaHelper::lua_runstring(const String *script) {
...
void LuaHelper::_lua_register(const String name, const lua_CFunction function) {
  lua_register(_state, name.c_str(), function);
}

String LuaHelper::addConstants() {
